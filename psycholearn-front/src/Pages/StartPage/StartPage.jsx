  ...
  return (
    <div className={classes.firstBlock}>
        <ModalWindow active={active} setActive={setActive}>
            <SignUpForm setActive={setActive} answer={answer} response={response} setResponse={setResponse} setAnswer={setAnswer} />
        </ModalWindow>

        <ModalWindow active={activeLogIn} setActive={setActiveLogIn}>
            <LogInForm response={response} setActiveLogIn={setActiveLogIn} setResponse={setResponse} />
        </ModalWindow>
